...
import { saveScheduleApi } from "../../api/authapi";
  ...
  */
  ...
  const saveSchedule = async () => {
    try {
      ...
      console.log("Saving Ad Schedule Payload:", payload);
    ...
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <div style={styles.header}>
          <h2 style={styles.title}>📅 Advertisement Schedule</h2>
          <p style={styles.sub}>
            Select weekly available slots for this Advertisement
          </p>
        ...
        <button
          ...
          disabled={saving}
        >
          {saving ? "Saving..." : "Save Ad Schedule"}
        </button>
      </div>
    </div>
  );
