...
import { saveVehicleFenceApi } from "../../api/authapi";

const VehLocationScreen = () => {
  ...
  useEffect(() => {
    ...
    /*
      Only vehicle registration check
      No adId check here
    */
    if (!vehReg) {
  ...
  */
  const saveFence = async () => {
    try {
      ...
      console.log("Saving Vehicle Fence:", payload);

      await saveVehicleFenceApi(payload);

      alert("Vehicle Fence saved successfully!");
      navigate(-1);
    } catch (error) {
      console.log(error);
      alert("Failed to save vehicle fence");
    }
  };
    ...
    <div style={styles.page}>
      ...
      <main style={styles.main}>
        <div style={styles.card}>
          <h2 style={styles.title}>📍 Vehicle Fence</h2>

          <p style={styles.subTitle}>
            Click on map to create vehicle fence
...
export default VehLocationScreen;
