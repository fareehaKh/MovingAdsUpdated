...
export const getAdvertiserBillingApi = (userId) =>
  axios.get(`/billing/advertiser/${userId}/summary`);

export const getDriverBillingApi = (userId) =>
  axios.get(`/billing/driver/${userId}/summary`);

export const getAgencyBillingApi = (agencyId) =>
  axios.get(`/billing/agency/${agencyId}/summary`);
